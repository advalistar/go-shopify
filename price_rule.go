...
type PriceRule struct {
	...
	AllocationLimit                        string                                  `json:"allocation_limit"`
	...
	PrerequisiteToEntitlementQuantityRatio *prerequisiteToEntitlementQuantityRatio `json:"prerequisite_to_entitlement_quantity_ratio"`
